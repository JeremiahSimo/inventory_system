...
if (!isset($_SESSION['username']) || $mysqli->connect_error) {
  header("Location: index_Admin.php?page=admin_dashboard");
  exit();
}

$loggedInUsername = $_SESSION['username'] ?? null;

$stmt = $mysqli->prepare("SELECT employee_fname, employee_roles, employee_id FROM employee_list WHERE employee_username = ?");
if ($stmt) {
    $stmt->bind_param("s", $loggedInUsername);
    $stmt->execute();
    $stmt->bind_result($userName, $userRole, $employee_id);
    $stmt->fetch();
    $stmt->close();
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="#">
        <input type="text" name="query" placeholder="Search2" title="Enter search keyword">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo isset($userName) ? $userName : 'Unknown User'; ?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo isset($userName) ? $userName : 'Unknown User'; ?></h6>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($_GET['page'] ?? '') === 'admin_dashboard'  ? 'active' : ''; ?>" href="index_admin.php?page=admin_dashboard">
      ...
      <li class="nav-item">
        ...
        <ul id="violation-nav" class="nav-content collapse <?php echo ($_GET['page'] ?? '') === 'employee_prev' || ($_GET['page'] ?? '') === 'employee_reg' ? 'show' : ''; ?>" data-bs-parent="#sidebar-nav">
          <li>
            <a href="index_admin.php?page=employee_prev" class="<?php echo ($_GET['page'] ?? '') === 'employee_prev'  ? 'active' : ''; ?>">
              <i class="bi bi-circle"></i><span>Empployee Preview</span>
            </a>
          </li>
          <li>
            <a href="index_admin.php?page=employee_reg" class="<?php echo ($_GET['page'] ?? '') === 'employee_reg'  ? 'active' : ''; ?>">
              <i class="bi bi-circle"></i><span>Employee Regiistration</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse <?php echo ($_GET['page'] ?? '') ==='items_prev' || ($_GET['page'] ?? '') ==='items_receiving' || ($_GET['page'] ?? '') ==='items_reg'|| ($_GET['page'] ?? '') ==='items_releasing' || ($_GET['page'] ?? '') ==='items_reports'? 'show' : ''; ?>" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="index_admin.php?page=items_receiving" class="<?php echo ($_GET['page'] ?? '') === 'items_receiving'  ? 'active' : ''; ?>">
              <i class="bi bi-circle"></i><span>Items Receiving</span>
            </a>
          </li>
          <li>
  ...
  <main id="main" class="main">
    ...
    <section class="section"> 
      ...
      if (isset($_GET['page'])) {
        ...
        switch ($page) {
            case 'employee_reg':
                include 'api/employee_reg.php';
                break;
            case 'employee_prev':
                include 'api/employee_prev.php';
                break;
                case 'admin_dashboard':
                  include 'api/dashboard.php';
                  break;
                  case 'items_reg':
                    include 'api/items_inventory_reg.php';
                    break;
                    case 'items_prev':
                      include 'api/items_inventory_prev.php';
                      break;
