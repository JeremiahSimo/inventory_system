    ...
    function editData(edit_employee_id,edit_employee_fname,edit_employee_mname,edit_employee_lname,edit_Date_hired,edit_email,edit_employee_bday,edit_username,edit_password,location_name) {
        ...
        var locationSelect = document.getElementById("edit_location_code");
        for (var i = 0; i < locationSelect.options.length; i++) {
            if (locationSelect.options[i].text === location_name) {
